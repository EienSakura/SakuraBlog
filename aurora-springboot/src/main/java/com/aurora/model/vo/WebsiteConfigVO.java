...
public class WebsiteConfigVO {
    ...
    @ApiModelProperty(name = "heroBackground", value = "首页背景图", required = false, dataType = "String")
    private String heroBackground;

    @ApiModelProperty(name = "hitokotoSource", value = "一言来源", required = false, dataType = "String")
    private String hitokotoSource;

    @ApiModelProperty(name = "hitokotoCustomText", value = "自定义一言内容", required = false, dataType = "String")
    private String hitokotoCustomText;
