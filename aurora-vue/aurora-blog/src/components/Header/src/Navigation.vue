    ...
    <ul class="flex flex-row list-none px-6 text-white">
      ...
      <li
        ...
        <Dropdown hover class="nav-link text-sm block px-1.5 py-0.5 rounded-md relative uppercase">
          <span class="relative z-50" v-if="$i18n.locale === 'cn'" @click="pushPage('/photos')"> 相册 </span>
          <span class="relative z-50" v-else-if="$i18n.locale === 'en'" @click="pushPage('/photos')"> PhotoAlbums </span>
          <DropdownMenu>
