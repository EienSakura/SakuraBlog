...
import { showMessage, i18n } from './message';
import type { Config, ModelManager } from './model';
import type { Tips } from './widget';
    ...
    this.tools = {
      ...
      photo: {
        ...
        callback: () => {
          ...
          if (message) showMessage(message, 6000, 9);
      ...
      quit: {
        ...
        callback: () => {
          ...
          if (message) showMessage(message, 2000, 11);
